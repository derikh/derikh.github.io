...
function render(tick) {
	if (moving) {
		...
		if (Math.abs(t - audio.currentTime) > .25) {audio.currentTime += (t - audio.currentTime);}
		...
		theSet = sets[s]
		currentSet = s;
		// movementOutput.textContent = theSet.movement; i fuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuu
